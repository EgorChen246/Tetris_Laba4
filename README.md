...
Добавлен файл scores.json для хранения максимального счёта. В Board.py добавлен метод save_score(), вызываемый в lock_piece() при обновлении рекорда. Загрузка в init(). Фрагмент: 
